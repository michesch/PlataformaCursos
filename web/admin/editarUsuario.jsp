                    ...
                    <div class="container-fluid px-4">
                        ...
                        <form action="config/editarUsuario.jsp?id=<%=rs.getString("id")%>" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="name" value="<%=rs.getString("name")%>" placeholder="Informe seu nome" />
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Email</label>
                                <input type="email" class="form-control" name="email" value="<%=rs.getString("email")%>" placeholder="Informe seu Email" />
                            </div>                         
                            <div class="mb-3">
                                <label class="form-label">Senha</label>
                                <input type="password" class="form-control" name="pass" value="<%=rs.getString("pass")%>" placeholder="Informe uma senha" />
                            </div>
