...
<%
    ...
    if(up.formProcess(getServletContext(), request)) {
        ...
        try {
            ...
            st.executeUpdate("UPDATE workshop set name = '"+nome+"', descr = '"+desc+"', imagem= '"+imagem+"', valor = '"+valor+"' WHERE id = '"+id+"' ");
 
            File file = new File("C:\\Users\\miche\\Documents\\Cursos\\michelle_java_noturno\\FRAMEWORK\\PlataformaCursos\\web\\arquivos"+nameImg);
            file.delete();
 
            response.sendRedirect("../workshops.jsp?status=2"); //Atualizado com sucesso.
        } catch (Exception e) {
            out.print(e);
        }
