...
<%
    ...
    if(up.formProcess(getServletContext(),request)){
        ...
        try{
            ...
            st.execute("INSERT INTO workshop(name,descr,imagem,valor)VALUES('"+nome+"','"+desc+"', '"+imagem+"', '"+valor+"')");
            response.sendRedirect("../workshops.jsp?status=1");//Adicionado com sucesso
        }catch(Exception e){
            out.print(e);
        }
