...
<body>
    <main class="login-body" data-vide-bg="../assets/img/login-bg.jpg">
        <!-- Login Admin -->
            ...
            <div class="login-form">
                ...
                <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="password" name="pass" class="form-control" id="exampleFormControlInput1" placeholder="Senha">
                      </div> 
                 <div class="footer">
